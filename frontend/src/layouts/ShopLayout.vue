<template>
  <v-app class="bg-surface font-sans">
    ...
    >
      <div class="pa-6 text-center">
        <v-avatar
          size="80"
          color="secondary"
          class="mb-4 text-white font-weight-bold text-h4"
        >
    ...
    <v-app-bar flat fixed class="floating-capsule-appbar" height="80">
      <v-container class="d-flex align-center h-100 px-6" fluid>
        <!-- Left: Branding -->
        <div
          class="d-flex align-center cursor-pointer logo-section"
        ...
        <!-- Center: Navigation -->
        <div
          class="d-none d-md-flex align-center flex-grow-1 justify-center nav-items-wrapper"
        >
          <v-btn
            v-for="item in items"
            :key="item.title"
    ...
    >
      <div class="d-flex flex-column h-100">
        <div class="pa-6 bg-primary text-white">
          ...
          <div
            class="d-flex align-center text-teal-lighten-4 text-subtitle-2 bg-white/10 py-2 px-3 rounded-lg w-fit"
          >
          ...
          <v-list v-else lines="two" bg-color="transparent" class="pa-0">
            <v-slide-y-transition group>
              ...
              >
                ...
                <v-list-item-title
                  class="font-weight-bold text-body-1 mb-1 text-primary"
                  >{{ item.name }}</v-list-item-title
                >
                <template v-slot:subtitle>
                  <div class="d-flex align-center justify-space-between mt-2">
                    <div class="font-weight-black text-h6 text-secondary">
        ...
        <div class="pa-6 bg-white border-t elevation-4" v-if="cartItems.length">
          ...
          <div class="d-flex justify-space-between align-end mb-6">
            ...
            <span class="text-h4 font-weight-black text-secondary lh-1"
    ...
    <v-dialog v-model="checkoutDialog" max-width="500">
      <v-card class="rounded-xl overflow-hidden elevation-24">
        <div class="bg-primary pa-8 text-white pb-12 relative overflow-hidden">
          ...
          <div class="text-grey-lighten-3 relative z-1">
      ...
      <v-container>
        <v-row>
          <v-col cols="12" md="4" class="mb-8 mb-md-0">
            ...
            <p
              class="text-body-1 text-grey-lighten-1 mb-8"
            ...
            <div class="d-flex ga-4" v-if="siteInfo?.socials">
              <v-btn
                v-if="siteInfo.socials.facebook"
                icon
                variant="outlined"
                color="secondary"
                size="small"
                :href="siteInfo.socials.facebook"
                class="rounded-circle border-opacity-25"
                ><v-icon size="small">mdi-facebook</v-icon></v-btn
              >
              <v-btn
                v-if="siteInfo.socials.instagram"
                icon
                variant="outlined"
                color="secondary"
                size="small"
                ...
                class="rounded-circle border-opacity-25"
                ><v-icon size="small">mdi-instagram</v-icon></v-btn
              >
              <v-btn
                v-if="siteInfo.socials.twitter"
                icon
                variant="outlined"
                color="secondary"
                size="small"
                ...
                class="rounded-circle border-opacity-25"
                ><v-icon size="small">mdi-twitter</v-icon></v-btn
              >
            </div>
          </v-col>

          <v-col cols="6" md="2">
            <div class="text-subtitle-1 font-weight-bold mb-6 text-secondary">
              Explore
            </div>
            <div class="d-flex flex-column ga-3">
              <router-link
                to="/shop"
                class="text-decoration-none text-body-2 text-grey-lighten-2 hover-link"
                >Home</router-link
              >
              <router-link
                to="/shop/about"
          ...
          <v-col cols="12" md="4">
            ...
            <div class="d-flex align-start mb-4">
              <v-icon size="small" color="secondary" class="mr-3 mt-1"
            ...
            <div class="d-flex align-center mb-4">
              <v-icon size="small" color="secondary" class="mr-3"
                >mdi-phone</v-icon
              >
              <span class="text-body-2 text-grey-lighten-2">{{
                siteInfo?.phone
        ...
        >
          <div>
            © {{ new Date().getFullYear() }} {{ siteInfo?.name }}. All rights
            reserved.
          </div>
          <div class="mt-4 mt-md-0">Powered by Seyal Engine</div>
        </div>
      </v-container>
    </v-footer>
  </v-app>
...
export default {
  ...
  computed: {
    ...
    cartDrawer: {
      ...
      set(val) {
        if (!val) this.toggleDrawer();
      }, // Only handle close from v-model
    },
  },
  methods: {
...
.floating-capsule-appbar {
  ...
  box-shadow:
    ...
    0 5px 20px rgba(197, 160, 101, 0.15),
    /* Golden Glow */ inset 0 1px 2px rgba(255, 255, 255, 0.8);
