  ...
  <div class="products-view bg-surface h-100 font-sans">
      ...
      <v-container class="d-flex align-center py-0">
        ...
        >
          <img
            ...
            alt="Seyal Logo"
            height="60"
            class="mr-3 elevation-1 rounded-lg"
          />
        </div>
        <v-spacer></v-spacer>
        ...
        >
          ...
          <span
            class="ml-3 bg-white px-3 py-1 rounded-pill text-caption font-weight-black text-teal-darken-3 elevation-1"
            v-if="cartTotalItems"
          >
            ₹{{ cartTotal.toFixed(0) }}
          </span>
    ...
    <v-main>
        ...
        <v-container class="relative z-1 py-16">
          <v-row align="center" justify="center" class="py-lg-16">
            <v-col cols="12" md="8" lg="7" class="text-center text-md-left">
              ...
              <h1
                class="text-h3 text-md-h2 text-lg-h1 font-weight-black mb-6 text-white lh-tight drop-shadow-sm font-heading"
              >
                Elevate Your <br />
                <span
                  class="text-transparent bg-clip-text bg-gradient-to-r from-teal-200 to-white"
                  >Daily Lifestyle.</span
                >
              </h1>

              <p
                class="text-h6 text-teal-lighten-4 mb-10 font-weight-regular lh-relaxed mx-auto mx-md-0"
                style="max-width: 600px"
              >
                Discover a curated selection of premium products designed to
                enhance your everyday life. Quality, delivered fast.
              </p>

              <div
                class="d-flex flex-column flex-sm-row gap-4 justify-center justify-md-start"
              >
                <v-btn
                  color="white"
                ...
                <div
                  class="hero-search-wrapper rounded-pill elevation-3 d-flex align-center bg-white px-2 mt-4 mt-sm-0"
            ...
            <v-col
              ...
              md="4"
              lg="5"
              class="d-none d-md-flex justify-end relative"
            >
              <div
                class="floating-card rounded-xl bg-white/10 backdrop-blur-md pa-6 border-white/20 border-thin elevation-10"
                style="width: 380px"
              >
                <div class="d-flex align-center mb-6">
                  ...
                  <div>
                    ...
                    <div class="text-teal-lighten-4 text-caption">
                ...
                <div
                  class="h-32 w-full bg-gradient-to-br from-white/10 to-transparent rounded-lg mb-4 border-white/10 border-thin"
                ></div>
              </div>
            </v-col>
          </v-row>
      ...
      <v-container id="products-section" class="pb-16">
        <div class="d-flex justify-space-between align-end mb-10">
          <div>
            <div class="text-overline text-teal font-weight-bold ls-2 mb-1">
              OUR CATALOG
            </div>
            <h2
              class="text-h3 font-weight-bold text-grey-darken-4 font-heading"
            >
              Featured Products
            </h2>
          </div>
        ...
        <div class="d-flex overflow-x-auto gap-2 mb-8 hide-scrollbar">
          <v-chip
            ...
            :class="
              selectedCategory === cat ? 'text-white' : 'text-grey-darken-1'
            "
        ...
        <v-fade-transition mode="out-in">
          <v-row :key="selectedCategory">
            ...
            >
              <div
                class="bg-grey-lighten-5 rounded-circle d-inline-flex pa-8 mb-6"
              >
    ...
    >
      <div class="d-flex flex-column h-100">
        <div class="pa-6 bg-teal-darken-4 text-white">
          ...
          <div
            class="d-flex align-center text-teal-lighten-4 text-subtitle-2 bg-teal-darken-3 py-2 px-3 rounded-lg w-fit"
          >
        ...
        <div class="flex-grow-1 overflow-y-auto bg-grey-lighten-5 px-4 pt-4">
          <div
            v-if="cart.length === 0"
            class="d-flex flex-column align-center justify-center fill-height pb-16 text-center"
          >
            <v-img
              src="https://cdn-icons-png.flaticon.com/512/11329/11329060.png"
              width="120"
              class="mb-6 opacity-60 grayscale"
            ></v-img>
            ...
            <v-slide-y-transition group>
              ...
              >
                <template v-slot:prepend>
                  <div
                    class="rounded-lg bg-grey-lighten-4 mr-4 d-flex align-center justify-center overflow-hidden"
                ...
                <v-list-item-title
                  class="font-weight-bold text-body-1 mb-1 text-grey-darken-4"
                  >{{ item.name }}</v-list-item-title
                >
                <template v-slot:subtitle>
                  <div class="d-flex align-center justify-space-between mt-2">
                    <div class="font-weight-black text-h6 text-teal-darken-2">
                      ₹{{ (item.unit_price * item.qty).toFixed(2) }}
                    </div>

                    <div
                      class="d-flex align-center bg-grey-lighten-5 border rounded-pill px-1"
                    >
                      <v-btn
                        icon="mdi-minus"
                        size="x-small"
        ...
        <div class="pa-6 bg-white border-t elevation-4" v-if="cart.length">
          <div
            class="d-flex justify-space-between text-subtitle-1 mb-2 text-grey-darken-1 font-weight-medium"
          >
            <span>Subtotal</span>
          ...
          <div class="d-flex justify-space-between align-end mb-6">
            <span class="text-h6 text-grey-darken-3 font-weight-bold"
              >Total</span
            >
            <span class="text-h4 font-weight-black text-teal-darken-3 lh-1"
    ...
    <v-dialog v-model="checkoutDialog" max-width="500">
      <v-card class="rounded-xl overflow-hidden elevation-24">
        <div
          class="bg-teal-darken-3 pa-8 text-white pb-12 relative overflow-hidden"
        >
          <div class="absolute-bg-pattern opacity-10"></div>
          <div class="text-h5 font-weight-black relative z-1">Checkout</div>
          <div class="text-teal-lighten-4 relative z-1">
    ...
    <v-dialog v-model="successDialog" max-width="420">
      <v-card class="text-center pa-8 rounded-xl">
        <div
          class="d-inline-flex justify-center align-center bg-green-lighten-5 rounded-circle mb-6 elevation-0"
          style="width: 100px; height: 100px"
        >
          <v-icon size="56" color="success">mdi-check-decagram</v-icon>
        </div>
        <h3 class="text-h4 font-weight-black text-grey-darken-4 mb-2">
          Order Placed!
        </h3>
        ...
        <v-btn
          ...
          >Track on WhatsApp</v-btn
        >
        <v-btn variant="text" block class="mt-4" @click="successDialog = false"
          >Close</v-btn
        >
      </v-card>
    </v-dialog>
  ...
  computed: {
    ...
    computedCategories() {
      ...
      const brands = new Set(
        this.products.map((p) => (p.brand ? p.brand.name : "General")),
      );
    ...
    filteredProducts() {
      ...
      if (this.selectedCategory !== "All") {
        res = res.filter(
          (p) => (p.brand ? p.brand.name : "General") === this.selectedCategory,
        );
      }
...
.from-teal-200 {
  --tw-gradient-stops: #b2f5ea, var(--tw-gradient-to, #ffffff);
}
.to-white {
