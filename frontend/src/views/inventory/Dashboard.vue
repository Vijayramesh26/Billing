<template>
  <div class="bg-background fill-height">
    ...
    <v-app-bar app color="surface" elevation="0" class="px-md-4 border-b-gold">
        <div v-if="companyLogo" class="d-flex align-center mr-3 cursor-pointer select-none" style="height: 100%; max-width: 200px;" @click="$router.push('/inventory')">
  ...
  data() {
    return {
      ...
      menuItems: [
        ...
        { title: 'Categories', icon: 'mdi-shape', to: '/inventory/categories' },
